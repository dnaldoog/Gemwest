...
void CGemCut::dictInitializer() {
	Dictionary<String^, Double>^ gemCut = gcnew Dictionary<String^, Double>;
...
void CGemCut::setCut(Dictionary<String^, Double>^ arr) {
	this->m_gemCut = arr;

}

Decimal CGemCut::getCutFactor(String^ key) {
	return System::Convert::ToDecimal(this->m_gemCut[key]);
